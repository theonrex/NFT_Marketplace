...
contract NFTMarketplace is ERC721URIStorage, Ownable, ReentrancyGuard  {
    ...
    function updateListingPrice(uint _listingPrice) public payable {
      require(ownerAddress == msg.sender, "Only marketplace owner can update listing price.");
    ...
    function resellToken(uint256 tokenId, uint256 price) public payable onlyWhenNotPaused{
